...
// create directory button
{
								...
								btnDirec.setOnAction(new EventHandler<ActionEvent>() { // when the
																								...
																								public void handle(ActionEvent e) {
																																...
																																try // this try lets the user choose a directory from their
																								            // system
																																{
								...
								DirecBox.getChildren().addAll(DirecLoc, btnDirec); // the directory had
								// an hbox to keep
								// the textbox and
								// button aligned
...
private Button createButton()  // This function create the button which will
// create the application after the user
...
private Rectangle createContrast()  // This helps create an overlay onto the
// background (modeled after fluid's
// U.I.)
{
...
private Label createHeader()  // This creates a simple header for the
// application (modeled after fluid's U.I.)
{
